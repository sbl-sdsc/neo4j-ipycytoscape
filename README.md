...
### Launch Jupyter Lab on [Pangeo Binder](https://aws-uswest2-binder.pangeo.io/)
...
When running this project on [Pangeo Binder](https://aws-uswest2-binder.pangeo.io/), a Neo4j database server is [setup](../binder/postBuild) and [started](../binder/start). This may take a few minutes.
